...
public class ReservasView extends JFrame {
	...
	public Integer calculaDiferenca(String dataEntrada, String dataSaida) {
		Long dataEntradaEmMs = java.sql.Date.valueOf(dataEntrada).getTime();
		Long dataSaidaEmMs = java.sql.Date.valueOf(dataSaida).getTime();
		Long valorReserva = dataSaidaEmMs - dataEntradaEmMs;
		return valorReserva.intValue();
	}
